...
class Circle extends Shape {
    constructor(color, text, textColor){
        super(`circle cx="150" cy="100" r="80"`, color, text, textColor)
...
class Triangle extends Shape {
    constructor(color, text, textColor){
    super(`polygon points="0,200 300,200 150,0"`, color, text, textColor)
...
class Square extends Shape {
    constructor(color, text, textColor){
        super(`x="50" height="200" width="200"`,color, text, textColor)
